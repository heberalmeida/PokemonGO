...
if (Close == 'block') {
        ...
        button_view[index - 1].style.backgroundColor ='rgb(165, 58, 58)';
        button_view[index - 1].style.color ='white';
        button_view[index - 1].style.border ='1px solid rgb(165, 58, 58)';
    } 
}
...
const startRaidHour = 13,
      endRaidHour = startRaidHour + 0,
      startDayRaid = "Wed Jun 3 2020",
      endDayRaid = "Mon Jun 8 2020";
